...
public class NetworkManagerWithEvents : NetworkManager
{
    ...
    public new static NetworkManagerWithEvents singleton { get; private set; }
    ...
    {
        CallEvent(ServerCallbackActionType.StartHost);
    }
    ...
    {
        CallEvent(ServerCallbackActionType.StartClient);
    }
    ...
    {
        CallEvent(ServerCallbackActionType.StopHost);
    }
    ...
    {
        CallEvent(ServerCallbackActionType.StopServer);
    }
    ...
    [UsedImplicitly] public static Action OnStartServerEvent;
    [UsedImplicitly] public static Action OnStartClientEvent;
    [UsedImplicitly] public static Action OnStopHostEvent;
    [UsedImplicitly] public static Action OnStopServerEvent;
    [UsedImplicitly] public static Action OnStopClientEvent;
    ...
    private static void CallEvent(ServerCallbackActionType eventType)
    {
        ...
        var action = eventType switch
        {
            ...
            ServerCallbackActionType.StartServer => OnStartServerEvent,
            ServerCallbackActionType.StartClient => OnStartClientEvent,
            ServerCallbackActionType.StopHost => OnStopHostEvent,
            ServerCallbackActionType.StopServer => OnStopServerEvent,
            ServerCallbackActionType.StopClient => OnStopClientEvent,
